...
function twentyten_setup() {
  ...
  // define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyten_header_image_height', 198 ) );
    ...
    return "<div class='{$classes}'>" . ( $title == null ? "" : "<h3>{$title}</h3>") . "{$content}</div>";
  }
 ...
 *
 * Galleries are styled by the theme in 1up talent's style.css. This is just
 ...
 *
 * @since 1up talent 1.0
 * @deprecated Deprecated in 1up talent 1.2 for WordPress 3.1
 *
 ...
 * to remove the default style. Using 1up talent 1.2 in WordPress 3.0 will show the styles,
 * but they won't have any effect on the widget in default 1up talent styling.
 *
 * @since 1up talent 1.0
 */
